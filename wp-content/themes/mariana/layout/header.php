<html>
	<head>
		...
		<script src="<?php bloginfo('template_url'); ?>/js/mariana.js"></script>

		<title>Mariana etc</title>
		<!-- <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/imgs/icon_logo.png" />
		<link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/imgs/favicon.ico" type="image/x-icon" />
		<link rel="icon" type="image/ico" href="<?php bloginfo('template_url'); ?>/imgs/favicon.ico" /> -->
	</head>
